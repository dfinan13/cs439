...
public abstract class CPUBase implements ICPU {
    ...
    // These are here so lab3 student version can compile w/o TLB
    @Override
    ...
    public int xlatePageTable(long vaddr) {
        throw new IllegalStateException("Implement xlatePageTable()");
    }
   
	@Override
    public int xlateTLB(long vaddr) {
        throw new IllegalStateException("Implement xlateTLB()");
    }
   
	public static boolean PTE_SUPPORTED = true;	// Do Not Change.  Needed to compile.
